...
window.addEventListener("load", ()=>{
    ...
    ipcRenderer.on("summonerData", (e, data)=>{
        ...
        mDiv.innerHTML = "";
        let m = data.match; //전적 100개가 가져와짐
        m.forEach(x => {
...
function matchTemplate(match){
    let timeStamp = new Date(match.timestamp);
    ...
    let html = `
            ...
            <div class="down">
                ...
                <div class="match-info"><span>${timeStamp.toLocaleDateString()}</span></div>
            </div>`;
